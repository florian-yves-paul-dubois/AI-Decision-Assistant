...
# Function to make decisions based on conditions
...
# Function to query decisions based on the commute options
...
# Function to check multiple scenarios and print the results
